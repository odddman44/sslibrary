                        ...
                        <div class="menu-wrap">
                            <div class="navbar-header">
                                <div class="navbar-brand">
                                    <h1>
                                        <a href="index-2.html">
                                            <img src="${path}/com/images/libraria-logo-v3.png" alt="LIBRARIA" />
                                        </a>
                                    </h1>
                                </div>
                            </div>
                                    ...
                                    <div class="topbar-links">
                                        ...
                                        <div class="header-cart dropdown">
                                            ...
                                            <div class="dropdown-menu cart-dropdown">
                                                <ul>
                                                    <li class="clearfix">
                                                        <img src="${path}/com/images/header-cart-image-01.jpg" alt="cart item" />
                                                        <div class="item-info">
                                                            <div class="name">
                                                    ...
                                                    <li class="clearfix">
                                                        <img src="${path}/com/images/header-cart-image-02.jpg" alt="cart item" />
                                                        <div class="item-info">
                                                            <div class="name">
                                                                <a href="#">The Great Gatsby</a>
                                                            </div>
                                                    ...
                                                    <li class="clearfix">
                                                        <img src="${path}/com/images/header-cart-image-03.jpg" alt="cart item" />
                                                        <div class="item-info">
                                                            <div class="name">
                                                                <a href="#">The Great Gatsby</a>
                                                            </div>
        ...
        <div data-ride="carousel" class="carousel slide" id="home-v1-header-carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <figure>
                        <img alt="Home Slide" src="${path}/com/images/header-slider/home-v3/header-slide.jpg" />
                    </figure>
                    <div class="container">
            ...
            <div id="category-filter">
                <ul class="category-list">
                    <li class="category-item adults">
                        <figure>
                            <img src="${path}/com/images/category-filter/home-v1/category-filter-img-01.jpg" alt="New Releaase" />
                    ...
                    <li class="category-item kids-teens">
                        <figure>
                            <img src="${path}/com/images/category-filter/home-v1/category-filter-img-02.jpg" alt="New Releaase" />
                            <figcaption class="bg-blue">
                                <div class="info-block">
                                    <h4>The Great Gatsby</h4>
                                    <span class="author"><strong>Author:</strong> F. Scott Fitzgerald</span>
                    ...
                    <li class="category-item video">
                        <figure>
                            <img src="${path}/com/images/category-filter/home-v1/category-filter-img-03.jpg" alt="New Releaase" />
                            <figcaption class="bg-blue">
                                <div class="info-block">
                                    <h4>The Great Gatsby</h4>
                                    <span class="author"><strong>Author:</strong> F. Scott Fitzgerald</span>
                    ...
                    <li class="category-item audio">
                        <figure>
                            <img src="${path}/com/images/category-filter/home-v1/category-filter-img-04.jpg" alt="New Releaase" />
                            <figcaption class="bg-blue">
                                <div class="info-block">
                                    <h4>The Great Gatsby</h4>
                                    <span class="author"><strong>Author:</strong> F. Scott Fitzgerald</span>
                    ...
                    <li class="category-item books">
                        <figure>
                            <img src="${path}/com/images/category-filter/home-v1/category-filter-img-05.jpg" alt="New Releaase" />
                            <figcaption class="bg-blue">
                                <div class="info-block">
                                    <h4>The Great Gatsby</h4>
                                    <span class="author"><strong>Author:</strong> F. Scott Fitzgerald</span>
                    ...
                    <li class="category-item magazines">
                        <figure>
                            <img src="${path}/com/images/category-filter/home-v1/category-filter-img-06.jpg" alt="New Releaase" />
                            <figcaption class="bg-blue">
                                <div class="info-block">
                                    <h4>The Great Gatsby</h4>
                                    <span class="author"><strong>Author:</strong> F. Scott Fitzgerald</span>
                    ...
                    <li class="category-item adults">
                        <figure>
                            <img src="${path}/com/images/category-filter/home-v1/category-filter-img-07.jpg" alt="New Releaase" />
                            <figcaption class="bg-blue">
                                <div class="info-block">
                                    <h4>The Great Gatsby</h4>
                                    <span class="author"><strong>Author:</strong> F. Scott Fitzgerald</span>
                    ...
                    <li class="category-item kids-teens">
                        <figure>
                            <img src="${path}/com/images/category-filter/home-v1/category-filter-img-08.jpg" alt="New Releaase" />
                            <figcaption class="bg-blue">
                                <div class="info-block">
                                    <h4>The Great Gatsby</h4>
                                    <span class="author"><strong>Author:</strong> F. Scott Fitzgerald</span>
                        ...
                        <ul>
                            <li class="col-sm-3">
                                <div class="fact-item icon-ebooks">
                                    <div class="fact-icon">
                                        <img src="${path}/com/images/icon-ebooks.png" alt="" />
                                    </div>
                            ...
                            <li class="col-sm-3">
                                <div class="fact-item icon-eaudio">
                                    <div class="fact-icon">
                                        <img src="${path}/com/images/icon-eaudio.png" alt="" />
                                    </div>
                            ...
                            <li class="col-sm-3">
                                <div class="fact-item icon-magazine">
                                    <div class="fact-icon">
                                        <img src="${path}/com/images/icon-magazine.png" alt="" />
                                    </div>
                            ...
                            <li class="col-sm-3">
                                <div class="fact-item icon-videos">
                                    <div class="fact-icon">
                                        <img src="${path}/com/images/icon-videos.png" alt="" />
                                    </div>
                ...
                <div class="owl-carousel">
                    <div class="single-testimonial-box">
                        <div class="top-portion">
                            <img src="${path}/com/images/home-testimonial.jpg" alt="Testimonial Image" />
                    ...
                    <div class="single-testimonial-box">
                        <div class="top-portion">
                            <img src="${path}/com/images/home-testimonial-01.jpg" alt="Testimonial Image" />
                            <div class="user-comment">
                                <div class="arrow-left"></div>
                                <blockquote cite="#">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent urna magna, rhoncus eget commodo et, dignissim non nulla. Sed sit amet vestibulum ex. Donec dolor velit
                ...
                <div class="row">
                    ...
                    <div class="staff-list">
                        <div class="staff-member">
                            <figure>
                                <img src="${path}/com/images/team-img-04.jpg" alt="team" />
                            </figure>
                        ...
                        <div class="staff-member">
                            <figure>
                                <img src="${path}/com/images/team-img-05.jpg" alt="team" />
                            </figure>
                            <div class="content-block">
                                <div class="staff-info">
                        ...
                        <div class="staff-member">
                            <figure>
                                <img src="${path}/com/images/team-img-06.jpg" alt="team" />
                            </figure>
                            <div class="content-block">
                                <div class="staff-info">
                                    <h4>Anna Delpan</h4>
                        ...
                        <div class="staff-member">
                            <figure>
                                <img src="${path}/com/images/team-img-07.jpg" alt="team" />
                            </figure>
                            <div class="content-block">
                                <div class="staff-info">
                                    <h4>Anna Delpan</h4>
                ...
                <div class="tabs-container">
                    ...
                    <div class="tabs-list">
                        <div class="tab-content active">
                            <article>
                                <figure>
                                    <img src="${path}/com/images/latest-blog-img-home-v1.jpg" alt="Latest Blog">
                                    <figcaption>
                                        <a href="#.">
                        ...
                        <div class="tab-content">
                            <article>
                                <figure>
                                    <img src="${path}/com/images/latest-blog-img-home-v1-2.jpg" alt="Latest Blog">
                                    <figcaption>
                                        <a href="#.">
                ...
                <div class="row">
                    ...
                    <div class="news-events-list">
                        <div class="single-news-event">
                            <figure>
                                <img src="${path}/com/images/news-event/news-event-05.jpg" alt="News & Event" />
                            </figure>
                            <div class="content-block">
                        ...
                        <div class="single-news-event">
                            <figure>
                                <img src="${path}/com/images/news-event/news-event-02.jpg" alt="News & Event" />
                            </figure>
                            <div class="content-block">
                                <div class="member-info">
                                    <div class="content_meta_category">
                        ...
                        <div class="single-news-event">
                            <figure>
                                <img src="${path}/com/images/news-event/news-event-03.jpg" alt="News & Event" />
                            </figure>
                            <div class="content-block">
                                <div class="member-info">
                                    <div class="content_meta_category">
                        ...
                        <div class="single-news-event">
                            ...
                            <figure>
                                <img src="${path}/com/images/news-event/news-event-04.jpg" alt="News & Event" />
                            </figure>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 pull-right">
                            <ul>
                                ...
                                <li><a href="${path}/a01_main/books-media-list-view.html">Books &amp; Media</a></li>
