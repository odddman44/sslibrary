...
<head>
    ...
    <body class="sb-nav-fixed">
        ...
        <%@ include file="side_nav.jsp" %>
			...
			<main>
				<br>
				<h1 class="font-weight-bold text-center">대출/반납기록 조회</h1>
				<div class="container">
					...
					<table id="myTable" class="table table-hover table-striped">
						...
						<jsp:useBean id="search"
							class="sslibrary.frontweb.vo.RentalInfoForAdmin" />
						<jsp:setProperty name="search" property="*" />
						<tbody>
							<c:forEach var="record"
								items="${dao.searchRentalHistory(param.searchKeyword)}">
